...
const h8 = ({ onClose: e, categories: t, subCategories: n }) => {
  ...
  ri = async () => {
    const e = await fetch("http://127.0.0.1:3000/api/v1/products");
...
const oT = ({ product: e, method: t }) => {
  ...
  P8 = async ({ request: e, params: t }) => {
    ...
    let c = `http://127.0.0.1:3000/api/v1/products/${t.id}`;
    try {
...
const N8 = () => {
  ...
  Q1 = async ({ request: e }) => {
    ...
    return (
      (
        await fetch("http://127.0.0.1:3000/api/v1/products/create-products", {
          method: t,
          body: a,
        })
      ).ok
  ...
  L8 = async ({ request: e }) => {
    ...
    return (
      (
        await fetch(
          "http://127.0.0.1:3000/api/v1/products/category/create-category",
          {
            method: t,
  ...
  Y1 = async ({ request: e }) => {
    ...
    return (
      (
        await fetch(
          "http://127.0.0.1:3000/api/v1/products/subCategory/create-sub-category",
          {
            method: t,
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(r),
